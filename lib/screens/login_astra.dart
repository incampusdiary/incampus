...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    redirectedFromScreen = ModalRoute.of(context).settings.arguments as String;
    bool tappedSignInButton = false;
    // document = documents['first'];
    print('Login Screen Build started: $redirectedFromScreen');
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (!tappedSignInButton) {
                          tappedSignInButton = true;
                          ...
                          onTap: () async {
                            if (!tappedSignInButton) {
                              ...
                              if (currentUser != null) {
                                ...
                                if (redirectedFromScreen == 'Vetometer') {
                                  startTime();
                                  getUserResponse();
                                } else {
                              ...
                              if (redirectedFromScreen == 'Vetometer') {
                                ...
                                fetchSavedPosts();
                                await Future.delayed(Duration(seconds: 5));
                                Navigator.popAndPushNamed(context, NewsFeed.id);
                              }
                              tappedSignInButton = false;
                            }
                          },
